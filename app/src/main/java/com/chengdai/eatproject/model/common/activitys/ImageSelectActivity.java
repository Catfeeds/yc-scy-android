...
import com.chengdai.eatproject.uitls.CapturePhotoHelper;
import com.chengdai.eatproject.uitls.SystemUtils;
...
public class ImageSelectActivity extends Activity implements View.OnClickListener {
    ...
    public  final static String staticPath="ChengDai_PIC";
    private boolean isSplit = false;//是否裁剪

    private static final String CACHDIR = "ChengDaiPicimgcach";
