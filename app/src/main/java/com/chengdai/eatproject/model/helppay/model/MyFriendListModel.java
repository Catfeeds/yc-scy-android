package com.chengdai.eatproject.model.helppay.model;
...
public class MyFriendListModel implements Parcelable {
    ...
    public static final Parcelable.Creator<MyFriendListModel> CREATOR = new Parcelable.Creator<MyFriendListModel>() {
        @Override
