...
public class UserInfoDetailsModel implements Parcelable {
    ...
    protected UserInfoDetailsModel(Parcel in) {
        this.userId = in.readString();
        this.loginName = in.readString();
        this.nickname = in.readString();
        this.loginPwdStrength = in.readString();
    ...
    public static final Creator<UserInfoDetailsModel> CREATOR = new Creator<UserInfoDetailsModel>() {
        @Override
        public UserInfoDetailsModel createFromParcel(Parcel source) {
            return new UserInfoDetailsModel(source);
        }

        @Override
        public UserInfoDetailsModel[] newArray(int size) {
            return new UserInfoDetailsModel[size];
        }
    };
}
